...
// Source: github.com/longht077/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateTranfer(arg0 context.Context, arg1 db.CreateTranferParams) (db.Tranfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTranfer(arg0 context.Context, arg1 int64) (db.Tranfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTranfers(arg0 context.Context, arg1 db.ListTranfersParams) ([]db.Tranfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTranfer(arg0 context.Context, arg1 db.UpdateTranferParams) (db.Tranfer, error) {
	m.ctrl.T.Helper()
