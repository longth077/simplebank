...
mock:
	mockgen -package mockdb  -destination db/mock/store.go github.com/longht077/simplebank/db/sqlc Store
...
.PHONY: postgres createdb dropdb migrateup migratedown migrateup1 migratedown1 test server mock deploy